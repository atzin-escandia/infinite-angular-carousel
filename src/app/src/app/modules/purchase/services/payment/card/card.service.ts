...
import { INewCard, INewCardData } from '../../../../../interfaces';
...
@Injectable()
export class CheckoutPaymentCardService {
  get stripe(): any {
    return this.checkoutCommonSrv.getStripe();
  }

  constructor(
    private stripeSrv: StripeService,
    private checkoutStoreSrv: CheckoutStoreService,
    private checkoutCommonSrv: CheckoutPaymentCommonService,
